    ...
    return (
      <div className={`flex items-center p-3 bg-white border-2 border-gray-200 rounded-lg shadow-sm ${cardClass}`}>
        ...
        <div className="flex-auto flex-col ">
            ...
            <div className={`w-full ${accomplishmentClass}`}>
              <h4 className={`pt-5 mb-2 `}>{title? title : title_children}</h4>
            </div>
            <p className="text-[3vw] md:text-[1.1vw] text-gray-800 mt-3">{children}</p>
        </div>
      </div>
    );
  }
