...
const FirstView: React.FC<FirstViewProps> = ({ windowHeight, isMobile }) => {
  ...
  return (
    <div className="relative w-full mb-10" style={{ height: `${windowHeight}px`}}>
      {/* {isMobile && !playVideo && <div  className={`play-button`} style={{height: "100%", display: 'flex', justifyContent: 'center'}}>
        <button onClick={handlePlayVideo}>タップして再生</button>
      </div>} */}
