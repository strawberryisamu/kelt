...
const Details = () => {
        return (
            <section>
                <div id="Details" className='w-full px-[5%] mb-[5%] pt-[5%]'>
                {/* <h2 className='font-bold text-3xl md:text-5xl mt-5 mb-[30px] text-center'>Details</h2> */}
                <div className='w-full'>
                        <div className='flex  justify-between items-start flex-wrap gap-10'>
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Date</span></p>
                                <p className='text-lg'>
                            ...
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Target Age</span></p>
                                <div className=''>
                                    <p className='text-9xl font-serif'>18-25</p>
                                </div>
                            </div>
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Capacity</span></p>
                                <p className='text-lg '><span className='text-8xl font-serif'>6</span> people for each term</p>
                            </div>
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Actual Cost</span></p>
                                <p className='text-lg'>$ <span className='text-8xl font-serif'>500</span> - $ <span className='text-8xl font-serif'>900 </span>/person</p>
                                <p className='text-lg'>(Not included Transportation to and from island)</p>
                            </div>
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Accommodation</span></p>
                                <p className='text-8xl font-serif'>Kyodai-so</p>
                                <p className='text-lg'>(The participants live under the same roof)</p>
                            </div>
                            <div className='flex-[1_1_33%]'>
                                <p className='text-xl md:text-3xl font-bold'><span className='border-b-2'>Deadline of application</span></p>
