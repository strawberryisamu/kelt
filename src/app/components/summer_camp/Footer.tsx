...
function Footer (){
    return (
        <footer id ='footer' className="footer-002">
            <a href="#">
            Rishiri Island Summer Camp
            </a>
            <li className=" flex justify-center items-center pt-5">
                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/oji_japon/">
            ...
            <nav className="footer-002__list">
                <ul className="flex items-center ">
                    <li className="flex-1">
                        <a target="_blank" rel="noopener noreferrer"  href="https://bun-kei.com/" className="p-0">
                    ...
                    <li className="flex-1">
                        <a target="_blank" rel="noopener noreferrer" href="http://rishiri-zen.jp/" className="p-0">
                            <Image src="/images/zen_transparent.png" width={500} height={500} alt='bunkei_logo'className={`w-[100%] rounded-md`} 
