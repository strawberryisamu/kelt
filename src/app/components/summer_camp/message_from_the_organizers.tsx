...
const MessageFromTheOrganizers: React.FC = () => {
  return (
    <div>
        <section>
          <div className=''>
            <div className='font-bold text-3xl md:text-5xl mt-5 tracking-tight text-center'>
              Organizer
            </div>
            <div className='flex flex-col pt-2 justify-center items-center'>
              <div className='flex-1 w-[75%] md:w-[30%] pb-5'>
                <Image 
                  src='/images/imai.png' 
                  alt='imai' 
                  width={500} 
              ...
              <p className="text-sm pb-3 text-center">Sota Imai Faculty of Literature, Kyoto University</p> 
        ...
        <section>
          <div className=''>
            ...
            <div className='flex flex-col pt-2 justify-center items-center'>
              ...
              <p className="text-sm pb-3 text-center">Yukimune Oji, CEO, Bunkei Corp.</p> 
              <div className='flex-1 w-[75%] md:w-[60%] pt-[2.5%] pb-[5%] md:text-[1.5vw] text-[3vw]'>
